...
[CreateAssetMenu(fileName = "AmmoHitEffect_", menuName = "Scriptable Objects/Weapons/Ammmo Hit Effect")]
public class AmmoHitEffectSO : ScriptableObject
{
    ...
    private void OnValidate()
    {
        ...
        HelperUtility.ValidateCheckNullValue(this, nameof(ammoHitEffectPrefab), ammoHitEffectPrefab);
