...
public class RoomNodeGraphEditor : EditorWindow
{
    ...
    private void ShowContextMenu(Vector2 mousePositon)
    {
        GenericMenu menu = new GenericMenu();

        menu.AddItem(new GUIContent("Creat Room Node"), false, CreatRoomNdoe, mousePositon);
    ...
    private void CreatRoomNdoe(object mousePositionObject)
    {
        if (currentRoomNodeGraph.roomNodeList.Count == 0)
        {
            CreatRoomNodes(new Vector2(200f, 200f), roomNodeTypeList.list.Find(x => x.isEntrance));
        }

        CreatRoomNodes(mousePositionObject, roomNodeTypeList.list.Find(x => x.isNone));
    }

    private void CreatRoomNodes(object mousePositionObject, RoomNodeTypeSO roomNodeType)
    {
    ...
    {
        currentRoomNodeGraph.linePosition += detal;
    }
